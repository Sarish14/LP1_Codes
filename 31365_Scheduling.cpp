...
public:
    ...
    void sjf(int n)
    {
        ...
        while (complete_proc < n)
        {
            ...
            if (min_index != -1)                                        // there is some process in cpu
            {
                bt[min_index]--;
            }
            ...
            if (bt[min_index] == 0)									// if process is complete
            {
                ct[min_index] = time;
                complete_proc++;
            }
    ...
    void priority_scheduling(int n)                                // lower the number, higher the priority
    {
        float total_tat = 0;
        float total_wt = 0;
        bubbleSort(at, bt, bt1, priority, n);
