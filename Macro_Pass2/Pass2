...
public class pass_2 {
    ...
    public pass_2(String name, int pp, int kp, int mdtp, int kpdtp)
    {
        super();
        this.name = name;
        this.pp = pp;
...
BufferedReader irb = new BufferedReader(new FileReader("intermediate.txt"));
        ...
        HashMap<String, pass_2> mnt = new HashMap<>();
        ...
        while((line = mntb.readLine()) != null)
        {
            ...
            mnt.put(parts[0], new pass_2(parts[0], Integer.parseInt(parts[1]), Integer.parseInt(parts[2]), Integer.parseInt(parts[3]), Integer.parseInt(parts[4])));
        }
